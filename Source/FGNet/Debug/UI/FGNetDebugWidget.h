...
#include "FGNetDebugWidget.generated.h"
 ...
 public:
 	...
 	UFUNCTION(BlueprintCallable, Category = Widget)
 		void UpdateNetworkSimulationSettings(const FFGBlueprintNetworkSimulationSettings& InSettings);
 
 	UFUNCTION(BlueprintImplementableEvent, Category = Widget, Meta = (DisplayName = "On Update Networks Simulation Settings"))
 		void BP_OnUpdateNetworkSimulationSettings(const FFGBlueprintNetworkSimulationSettingsText& Settings);
