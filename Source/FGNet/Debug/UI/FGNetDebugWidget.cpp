  #include "FGNetDebugWidget.h"
   ...
   void UFGNetDebugWidget::UpdateNetworkSimulationSettings(const FFGBlueprintNetworkSimulationSettings& InSettings)
   {
   	if (UWorld* World = GetWorld())
   	{
   		if (World->GetNetDriver() != nullptr)
   		{
   			...
   			FFGBlueprintNetworkSimulationSettingsText SettingsText;
